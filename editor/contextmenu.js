class ContextMenuManager {
  ...
  setupEventListeners() {
    ...
    document.addEventListener("click", (e) => {
      if (
        ...
        !this.editorContextMenu.contains(e.target)
      ) {
        this.hideAllMenus();
      }
    });
  ...
  setupMenuActions() {
    ...
    const tabMenuItems =
      this.tabContextMenu.querySelectorAll(".context-menu-item");
    ...
    const editorMenuItems =
      this.editorContextMenu.querySelectorAll(".context-menu-item");
